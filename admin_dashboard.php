...
<div class="container">
  ...
  <table class="table table-striped table-bordered table-hover">
              ...
              $q = "SELECT * from bot_data_collection WHERE is_resolved='no'";
  ...
  <div class="row">
    ...
    <div class="col-sm-6 col-md-6 center"><button id="resolved_btn" class="btn btn-danger text-center " onclick="document.location='resolved.php'">Already Resolved</button></div>
  </div>
</div>
